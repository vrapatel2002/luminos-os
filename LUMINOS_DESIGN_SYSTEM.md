...
```
1. Every color/radius/spacing/motion value must come from design/luminos-tokens.json (QML: Theme.qml; KDE: Luminos.colors; GTK: gtk.css — all generated by scripts/luminos-theme-gen). Never hardcode. [CHANGE: claude-code | 2026-06-14] was the now-archived luminos_theme.py
