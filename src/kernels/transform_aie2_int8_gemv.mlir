...
// Parameters: l1_m=64, l1_n=64, l2_k=64, pack=[8,8,8], accum=i32, contract_in=i16
//
...
module attributes {transform.with_named_sequence} {
  transform.named_sequence @__transform_main(%arg1: !transform.any_op {transform.readonly}) {
    ...
    //==========================================================================
        ...
        // Cast accumulator (input[2]) and output[0] to i32
        ...
        // Cast vector.contract inputs 0,1 to i16
        ...
        %result11b = transform.air.vector_type_cast %vector_contracts_2 {target_element_type = i16, input_indices = [0, 1], output_indices = []} : (!transform.any_op) -> !transform.any_op
