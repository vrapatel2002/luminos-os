...
| Chrome GPU | ✅ Fixed | Native AUR google-chrome-stable only — Flatpak removed. AMD: --use-gl=egl + Mesa-only EGL from /etc/environment. VAAPI on 780M. GPU selector dialog. renderD128=NVIDIA, renderD129=AMD. |
