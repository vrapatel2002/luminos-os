...
| HIVE popup (SUPER+SPACE) | ✅ Working | QML6 native UI, optimized scroll (ListView), LocalStorage persistence, System theme matching (dark/light), Copy button on AI messages (Selectable TextEdit for Wayland), HIVE Team Identity (System prompts) |
