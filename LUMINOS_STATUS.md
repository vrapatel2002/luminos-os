...
| Server OS install | 📋 Blocked on user | Needs the Arch ISO written to a USB stick (**this erases the NTFS stick**, which currently holds a movie for the TV) and the laptop's **brand** for its boot-menu key. |
